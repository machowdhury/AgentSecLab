...
**Phase:** 2C.1 SPL validation (investigation searches only)  
**Version:** 0.3.0  
...
**Last pytest:** 60 passed, 1 skipped (2026-09-11)
...
| Dashboard Studio / detections | NOT ATTEMPTED | out of Phase 2C.1 scope |
