#!/usr/bin/env python3
"""Capture LAB-MCP-004 Dashboard Studio screenshots from Splunk Web.
...
SPECIMEN_IDS = {
    "run_id": "fb50dcaf-8e84-4a3f-a55b-997c72edbd04",
...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        default=str(ROOT / "docs" / "screenshots" / "lab-mcp-004"),
    ...
    report: dict = {
        "url": "http://127.0.0.1:8000/en-US/app/agentsec/ws_lab_mcp_004",
        "tabs_found": [],
        "tabs_missing": [],
        "tokens_found": [],
        "tokens_missing": [],
