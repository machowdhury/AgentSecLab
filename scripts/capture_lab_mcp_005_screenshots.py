#!/usr/bin/env python3
"""Capture LAB-MCP-005 Dashboard Studio screenshots from Splunk Web.
...
SPECIMEN_IDS = {
    "run_id": "3013aa39-fe08-4b58-9898-f3abb092ac06",
...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        default=str(ROOT / "docs" / "screenshots" / "lab-mcp-005"),
    ...
    report: dict = {
        "url": "http://127.0.0.1:8000/en-US/app/agentsec/ws_lab_mcp_005",
        "tabs_found": [],
        "tabs_missing": [],
        "tokens_found": [],
        "tokens_missing": [],
