#!/usr/bin/env python3
"""Capture LAB-MCP-006 Dashboard Studio screenshots from Splunk Web.
...
SPECIMEN_IDS = {
    "run_id": "1cf98c4d-1bd8-4df5-be70-b82419e2c2b2",
...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        default=str(ROOT / "docs" / "screenshots" / "lab-mcp-006"),
    ...
    report: dict = {
        "url": "http://127.0.0.1:8000/en-US/app/agentsec/ws_lab_mcp_006",
        "tabs_found": [],
        "tabs_missing": [],
        "tokens_found": [],
        "tokens_missing": [],
