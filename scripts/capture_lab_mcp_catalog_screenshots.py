#!/usr/bin/env python3
"""Capture LAB-MCP-CATALOG Dashboard Studio screenshots from Splunk Web.
...
CLIP_TABS = ("LEARN", "RETEST", "COMPARE")
...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        default=str(ROOT / "docs" / "screenshots" / "lab-mcp-catalog"),
    ...
    report: dict = {
        "url": "http://127.0.0.1:8000/en-US/app/agentsec/ws_lab_mcp_catalog",
        "tabs_found": [],
        "tabs_missing": [],
        "tokens_found": [],
        "tokens_missing": [],
